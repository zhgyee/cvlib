...
int g2o_test_main() {
  ...
  std::normal_distribution<double> distribution(0.0, w_sigma * w_sigma);
...
int main() {
  ...
  int time = std::chrono::duration_cast<std::chrono::duration<int, std::milli> >(end - start).count();
  std::cout<< "End g2o, time used(ms):" << time<<std::endl;
